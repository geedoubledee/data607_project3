...
my_url_text_df <- "https://raw.githubusercontent.com/geedoubledee/data607_project3/main/text_df.csv"
text_df <- read.csv(file = my_url_text_df, header = TRUE)
...
if (length(files) > 0){
    ...
    text_df <- text_df[c("Text", "Job_id", "Line")]
