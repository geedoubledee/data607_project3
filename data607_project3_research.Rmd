...
Borrowed R scripts from Coco and Mo to do comparative analysis.
...
text_data1 <- str_replace_all(text_data, "[^[:alnum:]]", "")
text_data2 <- str_replace_all(text_data1, "[[:punct:]]", "")

head(text_data2)
# Coco's R script
text_df_clean <- text_data2
text_df_clean[, 1] <- tolower(text_df_clean[, 1])
text_df_clean %<>%
    filter(Text != "")
